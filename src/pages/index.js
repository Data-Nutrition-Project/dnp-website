...
const IndexPage = (props) => (
  <Layout>
    <section
        id="slider"
        className={classNames(style.slider,style.sliderParallax,'full-screen', 'dark')}
    >
            <div className={style.sliderParallaxInner}>
                <div className="container vertical-middle clearfix">
                    <div className={style.headingBlock}>
                        <h1 className={style.pageTitleHeader}>{"The Data Nutrition Project"}</h1>
                        <span className={style.pageTitleSpan}>{"Empowering data scientists and policymakers with practical tools to improve AI outcomes"}</span>
                    </div>
