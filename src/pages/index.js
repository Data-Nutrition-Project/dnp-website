...
const IndexPage = (props) => (
    <Layout>
                ...
                <div className="container vertical-middle clearfix">
                    ...
                    <div className={styles.centerText}>
                        <Link to="/page-2" className={styles.tealButtonLink}>
                            <Button className={classNames(styles.tealButton, styles.modButtonLarge)}> 
                                <i className="icon-play-circle"></i>solution
                            </Button>
                        </Link>
                        <a className={styles.tealButtonLink} href="https://arxiv.org/abs/1805.03677" target="_blank" rel="noopener noreferrer">
                            <Button className={classNames(styles.tealButton, styles.modButtonLarge)}>
                ...
                <Row id="side-navigation">
                    <Col md={{ span: 4 }}>
                        <div id="snav-content1">
                            ...
                            of race and gender, while Nutrition Labels for data about trees may not require that module. <br /> <br /> To learn more, check out our <a href="https://ahmedhosny.github.io/datanutrition/" target="_blank" rel="noopener noreferrer">live prototype</a> built
                            on the Dollars for Docs dataset from <a href="https://www.propublica.org/" target="_blank" rel="noopener noreferrer">ProPublica</a>. A first draft of our paper can be found <a href="https://arxiv.org/abs/1805.03677" target="_blank" rel="noopener noreferrer">here</a>.
                        </div>
                    </Col>
                    <Col md={{ span: 8 }}>
                        <img
                ...
                <Row id="side-navigation">
                    ...
                    <Col md={{ span: 8 }}>
                        ...
                        <div class={styles.photoCredit}>
                            <span>Photo Credit: <a href="http://www.jsbenjamin.com/" target="_blank" rel="noopener noreferrer">Jess Benjamin</a></span>
                        </div>
                    </Col>
                </Row>
            </Container>
                    ...
                    <Row>
                        <Bio
                            ...
                            socialMedia={[
                                ...
                                {
                                    href: "https://www.linkedin.com/company/humanity-innovation-labs",
                                    icon: "icon-linkedin",
                                    className: "si-linkedin"
                                },
                                {
        ...
        <div id="section-faq" className={classNames(styles.section, styles.modPictureAbove, styles.modPictureBelow)}>
            <div className={classNames(styles.headingBlock, styles.centerText, styles.pageSection)}>
                <h2>Frequently Asked Questions</h2>
                <span className={styles.headingSubHeader}>A few questions you might have</span>
            </div>
            <Container className={styles.clearfix}>
                <Row>
                    <Col md={{ span: 6 }}>
                        <h4 id="faq-1"><strong>Q.</strong> Do you have a prototype or more information?</h4>
                        <p>
                            Yes, we do! You can take a look at a <a href="https://ahmedhosny.github.io/datanutrition/" target="_blank" rel="noopener noreferrer">live protoype</a> of the Dataset Nutrition Label for the Dollars for Docs dataset that our friends at <a href="https://www.propublica.org/"
                            target="_blank" rel="noopener noreferrer">ProPublica</a> have made available to our group. We are also currently working on a <a href="https://arxiv.org/abs/1805.03677" target="_blank" rel="noopener noreferrer">paper</a> describing our work, the <a href="https://ahmedhosny.github.io/datanutrition/"
                            target="_blank" rel="noopener noreferrer">protoype</a>, and future directions.
                        </p>

                        <div className={styles.line}></div>

                        <h4 id="faq-2"><strong>Q.</strong> What inspired this project?</h4>
                        <p>
                        ...
                        <h4 id="faq-7"><strong>Q.</strong> Whom have you been speaking with?</h4>
                        <p>
                        ...
                        <h4 id="faq-7"><strong>Q.</strong> Is your work open source?</h4>
                        <p>
                            Yes. You can view our <a href="https://ahmedhosny.github.io/datanutrition/" target="_blank" rel="noopener noreferrer">live protoype</a> here, and the code behind the prototype on <a href="https://github.com/ahmedhosny/datanutrition" target="_blank" rel="noopener noreferrer">Github</a>.
                        </p>
                    </Col>
                    <Col md={{ span: 6 }}>
                        <h4 id="faq-7"><strong>Q.</strong> Who is the intended beneficiary of this work?</h4>
                        <p>
                            ...
                            involved, please <a href="mailto:nutrition@media.mit.edu">contact us</a>.
                        </p>

                        <div className={styles.line}></div>

                        <h4 id="faq-7"><strong>Q.</strong> How will this project scale?</h4>
                        <p>
                        ...
                        <h4 id="faq-7"><strong>Q.</strong> Is this a Harvard/MIT project?</h4>
                        <p>
        ...
        <div id="section-support" className={classNames(styles.section, styles.modGray)}>
            <Container>
                                    ...
                                    >
                                        <div id="mc_embed_signup_scroll">
                                            <Form.Group className={styles.subscribeForm}>
                                                <Form.Label className={styles.subscribeLabel} for="mce-EMAIL">Receive updates from the team:</Form.Label>
                                                <Form.Control type="email" placeholder="Email Address" name="EMAIL" id="mce-EMAIL" />
                                            </Form.Group>
                                            <div id="mce-responses" className="clear">
                                                <div className="response" id="mce-error-response" style={{ display: 'none' }} />
                                                <div className="response" id="mce-success-response" style={{ display: 'none' }} />
                                                <div style={{ position: 'absolute', left: '-5000px' }} aria-hidden="true">
                                                    <Form.Control type="text" name="b_90e3cb18de9969a9a056d188f_95965c5243" tabindex="-1" value="" />
                                                </div>
                                                <div className={styles.centerText}>
                                                    <Button
                                                        as="input"
